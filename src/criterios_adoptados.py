...
CRITERIOS: Dict[str, Criterio] = {
    ...
    "h_relleno_min_concreto_tmc": Criterio(
        ...
        reemplazado_por="NO lo cierra ninguna norma de producto: ver la "
                        "fuente, punto (1). Este campo pedia antes 'la tabla "
                        "de alturas admisibles de la norma de producto para "
                        "la clase o calibre de la Fase 8', y esa tabla no "
                        "existe -- M 170M clasifica por D-load y su Nota 1 "
                        "excluye el relleno del alcance. Lo que puede cerrar "
                        "el criterio es una de dos, y las dos son decisiones "
                        "de proyecto, no lecturas: (a) adoptar la altura por "
                        "analogia con el 0.30 m que EG-2013 508.07 si fija "
                        "para HDPE, declarandola como tal; o (b) calcular la "
                        "cobertura minima por metodo estructural -- AASHTO "
                        "LRFD Sec. 12, que el Manual de Puentes no incorpora "
                        "(ver fuente, punto 2), o clase D-load con factor de "
                        "cama. Cualquiera de las dos convierte este criterio "
                        "en [A]: deja de haber fuente que lo cubra",
