...
class Registro:
    ...
    def partes_sin_cita_transcrita(self) -> Tuple[Tuple[str, str, str], ...]:
        ...
        HALLAZGO DE C8, y lo destapo abrir el canal: eran NUEVE de 38 --- las
        23 discrepancias declaradas en aquel momento tenian 52 partes, y 38
        de ellas nombraban una cita. El campo
