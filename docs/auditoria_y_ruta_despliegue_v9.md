...
| | Estado |
|---|---|
| **El software como herramienta** | Terminado. 13 módulos, **1517 passed + 1 skipped (1518 collected)** con `requirements-dev.txt` instalado — 1485 passed + 33 skipped sin PyMuPDF, mismo `collected`: los 32 tests que abren los PDF de `normas/` llevan `@pytest.mark.pdf`. GUI, exportación con trazabilidad |
