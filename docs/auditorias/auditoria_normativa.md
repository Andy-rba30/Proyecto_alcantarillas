...
|---|---|---|---|---|
| `temario_refutar_95.json` | 95 | 49 | 46 | `R95-050` |
| `temario_refutar_48.json` | 48 | 45 | 3 | `R48-046` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **55**. Se sostienen **27** · ajustados **27** · refutados **1** · fuera de alcance **0**.
