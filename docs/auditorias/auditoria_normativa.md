...
|---|---|---|---|---|
| `temario_refutar_95.json` | 95 | 29 | 66 | `R95-030` |
| `temario_refutar_48.json` | 48 | 25 | 23 | `R48-026` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **15**. Se sostienen **4** · ajustados **11** · refutados **0** · fuera de alcance **0**.
