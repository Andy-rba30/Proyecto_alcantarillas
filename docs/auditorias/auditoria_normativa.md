...
|---|---|---|---|---|
| `temario_refutar_95.json` | 95 | 39 | 56 | `R95-040` |
| `temario_refutar_48.json` | 48 | 35 | 13 | `R48-036` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **35**. Se sostienen **13** · ajustados **22** · refutados **0** · fuera de alcance **0**.
