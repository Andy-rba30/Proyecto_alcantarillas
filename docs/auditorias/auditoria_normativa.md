...
| `temario_refutar_48.json` | 48 | 30 | 18 | `R48-031` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **20**. Se sostienen **5** · ajustados **15** · refutados **0** · fuera de alcance **0**.
