...
|---|---|---|---|---|
| `temario_refutar_95.json` | 95 | 54 | 41 | `R95-055` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **63**. Se sostienen **31** · ajustados **31** · refutados **1** · fuera de alcance **0**.
