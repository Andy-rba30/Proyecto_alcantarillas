...
|---|---|---|---|---|
| `temario_refutar_95.json` | 95 | 34 | 61 | `R95-035` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **25**. Se sostienen **7** · ajustados **18** · refutados **0** · fuera de alcance **0**.
