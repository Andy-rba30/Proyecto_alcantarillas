...
| `temario_refutar_48.json` | 48 | 40 | 8 | `R48-041` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **40**. Se sostienen **17** · ajustados **23** · refutados **0** · fuera de alcance **0**.
