...
|---|---|---|---|---|
| `temario_refutar_95.json` | 95 | 44 | 51 | `R95-045` |
...
Ítems reabiertos y cerrados tras el corte de sesión: **45**. Se sostienen **22** · ajustados **23** · refutados **0** · fuera de alcance **0**.
