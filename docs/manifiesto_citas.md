...
| Alternativa citada si el barril no llena: procedimiento de barril parcialmente lleno — lo declara `geometria_control_salida` | Cap. III | HDS-5 | [CA:2058](src/criterios_adoptados.py:2058), [M4:836](src/modulos/M4_control.py:836) | [C] |
