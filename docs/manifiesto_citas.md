...
> **Nota sobre `NUMERAL_MANNING = "4.1"`** ([M3:142](src/modulos/M3_hidraulica.py:142)):
> es la **Sec. 4.1 de la hoja de ruta**, no un numeral del Manual MTC. Lo mismo
> vale para `NUMERAL_CRITICO` / `NUMERAL_ENTRADA` / `NUMERAL_SALIDA` = `"4.2.1"` / `"4.2"` / `"4.3"` ([M4:369](src/modulos/M4_control.py:369))
...
| Alternativa citada si el barril no llena: procedimiento de barril parcialmente lleno — lo declara `geometria_control_salida` | Cap. III | HDS-5 | [CA:2484](src/criterios_adoptados.py:2484), [M4:1012](src/modulos/M4_control.py:1012) | [C] |
...
| `NUMERAL_MANNING` | `"4.1"` (Sec. 4.1 de la hoja de ruta) | [M3:142](src/modulos/M3_hidraulica.py:142) |
| `NUMERAL_CRITICO` / `NUMERAL_ENTRADA` / `NUMERAL_SALIDA` | `"4.2.1"` / `"4.2"` / `"4.3"` | [M4:369](src/modulos/M4_control.py:369) |
