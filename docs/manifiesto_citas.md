...
| ✚ `RECUBRIMIENTO_MP_PISO_MM = 25.4` mm — piso absoluto sobre las barras principales, lo que impide que el factor 0.8 baje el recubrimiento por debajo de la pulgada: «*El recubrimiento mínimo sobre las barras principales, incluyendo las barras protegidas con un recubrimiento de resina epóxico, deberá ser de 1.0 in (25 mm)*». Se aplica la pulgada exacta, que es la mayor de las dos cifras que la propia frase escribe | num. 2.9.1.5.5.3, pág. impresa 377 | Manual de Puentes | [CN:2333](src/constantes_normativas.py:2333) | [N] |
...
| Valor | Numeral citado | Documento fuente (según la cita) | Archivo:línea | Etiqueta |
|---|---|---|---|---|
| `FS["capacidad_portante"] = {estático: 3.00, sísmico: 2.50}` | Art. 21 (21.1/21.2), pág. 34 | E.050 | [CN:2382](src/constantes_normativas.py:2382), [CN:2382](src/constantes_normativas.py:2382) | [N] |
| `FS["volteo"] = {estático: 1.50, sísmico: 1.25}` | num. 39.13.6 a), pág. 72 | E.050 | [CN:2382](src/constantes_normativas.py:2382), [CN:2382](src/constantes_normativas.py:2382) | [N] |
| `FS["deslizamiento"] = {estático: 1.50, sísmico: 1.25}` | num. 39.13.6 a), pág. 72 | E.050 | [CN:2382](src/constantes_normativas.py:2382), [CN:2382](src/constantes_normativas.py:2382) | [N] |
| `FS["estabilidad_global"] = {estático: 1.50, sísmico: 1.25}` | num. 39.13.6 b), pág. 72 | E.050 | [CN:2382](src/constantes_normativas.py:2382), [CN:2382](src/constantes_normativas.py:2382) | [N] |
| `FS["talud"] = {estático: 1.50, sísmico: 1.25}` | Art. 30.3, pág. 39 | E.050 | [CN:2382](src/constantes_normativas.py:2382), [CN:2382](src/constantes_normativas.py:2382) | [N] |
| `NUMERAL_C_PHI`: en cohesivos φ=0, en friccionantes c=0 (prohibido sumar) | Art. 20, pág. 33 | E.050 | [CN:2433](src/constantes_normativas.py:2433), [M9:1863](src/modulos/M9_cabezal.py:1863), [M9:1903](src/modulos/M9_cabezal.py:1903) | [N] |
| `NUMERAL_ZAPATA_TALUD_E050`: doble verificación (inclinación de superficie y de base + estabilidad global del talud) | Art. 30.1-30.2 | E.050 | [CN:2434](src/constantes_normativas.py:2434), [M9:2838](src/modulos/M9_cabezal.py:2838) | [N] |
| `SPT_PROF_MIN = 15.0` m | Art. 38 | E.050 | [CN:2453](src/constantes_normativas.py:2453) | [N] |
| `SPT_ESPACIAMIENTO = 1.0` m entre ensayos | **⚠ sin numeral propio** (hereda el Art. 38 de la línea anterior; `clase_sitio` sí lo cita como Art. 38) | E.050 | [CN:2454](src/constantes_normativas.py:2454), [CA:570-387](src/criterios_adoptados.py:570) | [N] |
...
| `ESPESOR_TEMPERATURA_DOS_CARAS = 0.250` m (refuerzo en dos caras; lo lee `requiere_temperatura_dos_caras`) | Art. 14.8.3 | E.060 | [CN:2683-320](src/constantes_normativas.py:2683), [M9:2961](src/modulos/M9_cabezal.py:2961) | [N] |
| `ESPACIAMIENTO_MAX_VECES_ESPESOR = 3.0` (≤ 3h) | Art. 14.3.3 | E.060 | [CN:2685](src/constantes_normativas.py:2685), [M9:2247](src/modulos/M9_cabezal.py:2247) | [N] |
| `ESPACIAMIENTO_MAX_ABSOLUTO = 0.400` m (400 mm) | Art. 14.3.3 | E.060 | [CN:2686-323](src/constantes_normativas.py:2686) | [N] |
| ↻ `CICLOPEO_FC_MATRIZ_MIN = 10.0` MPa — sigue siendo el valor de E.060, y **ya no es el que se verifica**. `NOR-E060-07`: sobre el mismo material rige también la **Clase G de la Tabla 503-07 del EG-2013 (14 MPa)**, y para una obra vial del MTC se aplica el mayor de los dos —`CICLOPEO_FC_MATRIZ_MIN_APLICABLE`—, con la misma regla del máximo que Sec. 0.2 usa para el recubrimiento. Citar solo el 10 MPa era declarar el requisito más bajo de los dos, y el que no es de una norma vial | Art. 22.10, págs. 194-195 | E.060 | [CN:2703](src/constantes_normativas.py:2703), `verificar_ciclopeo` [M9:3058](src/modulos/M9_cabezal.py:3058) | [N] |
| `CICLOPEO_FRACCION_PIEDRA_MAX = 0.30` del volumen | Art. 22.10, págs. 194-195 | E.060 | [CN:2704-328](src/constantes_normativas.py:2704) | [N] |
