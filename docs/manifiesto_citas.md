...
> (`NUMERAL_V6`, [M5:305](src/modulos/M5_verificaciones.py:305)). Ver §11.
...
| `NUMERAL_V4` — `ReferenciaNormativa`: `seccion_hoja_ruta="Sec. 5.1"` / `numeral_norma="Manual de Suelos…, num. 4.5.4 y 9.1(3)"` | 4.5.4 y 9.1(3) | Manual de Suelos | [M5:272](src/modulos/M5_verificaciones.py:272) | [N→] |
| `resguardo_por_cbr()` — tabla de CBR aplicada en V4 | num. 4.5.4 | Manual de Suelos | [M5:1125](src/modulos/M5_verificaciones.py:1125) | [N] |
...
| `empuje_flotacion_kn_m()` — U por metro lineal, conducto sumergido | num. 2.4.3.8.2 | Manual de Puentes | [M8:249](src/modulos/M8_estructural.py:249), [M8:251](src/modulos/M8_estructural.py:251) | [N] |
| `NUMERAL_V7 = "Fase 5, V7 (Manual de Puentes num. 2.4.3.8.2 + Fase 8, item 3)"` | 2.4.3.8.2 | Manual de Puentes | [M5:306](src/modulos/M5_verificaciones.py:306), [M8:193](src/modulos/M8_estructural.py:193) | [N] |
...
| **Afirmación negativa**: AASHTO LRFD Sec. 12 NO está incorporada por el Manual de Puentes (difiere rigidez de anillo, pandeo y costura) — lo declara `verificacion_diferida_estructural` | Sec. 12 de AASHTO, no incorporada | Manual de Puentes | [M8:448](src/modulos/M8_estructural.py:448), [M8:448](src/modulos/M8_estructural.py:448), [M8:448](src/modulos/M8_estructural.py:448) | [C] |
...
| Rigidez de anillo, pandeo y resistencia de costura: **diferidos al expediente** — lo declara `verificacion_diferida_estructural` | Sec. 12 | AASHTO LRFD | [M8:448](src/modulos/M8_estructural.py:448), [M8:448](src/modulos/M8_estructural.py:448) | [C] |
...
| `NUMERAL_V6` | `"3.1"` | [M5:305](src/modulos/M5_verificaciones.py:305) |
| `NUMERAL_V8` | `"Fase 5, V8"` — "[N] verificación, no diseño, sin numeral que fije el TR ni el umbral": el TR y el umbral que faltan son los del criterio `TR_evento_extremo`, que `M5.v8_evento_extremo` invoca y que sigue vacío | [M5:311](src/modulos/M5_verificaciones.py:311), [CA:2637](src/criterios_adoptados.py:2637) |
| `NUMERAL_V9` | `"Sec. 3.2 (V9, nuevo en v7)"` | [M5:312](src/modulos/M5_verificaciones.py:312) |
...
|---|---|---|---|
| `remanso_derecho_via = None` | Manual de Diseño Geométrico **DG-2018** + **Ley 29338**; requiere perfil de remanso (paso a paso o HEC-RAS) | [CA:2534](src/criterios_adoptados.py:2534), [M5:315](src/modulos/M5_verificaciones.py:315) | [A] |
