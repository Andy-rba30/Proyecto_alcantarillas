...
| `n_q_zapata_en_talud()` = 0.0; N_c y N_γ **reemplazados** por N_cq y N_γq | num. 2.8.1.3.1.2c, págs. 272-273 | Manual de Puentes | [M9:2231](src/modulos/M9_cabezal.py:2231), [M9:2231-1049](src/modulos/M9_cabezal.py:2231) | [N] |
...
| `procedimiento_flexion_corte_aashto_sec5 = None` — remisión a AASHTO Sec. 5 | Manual de Puentes Sección 2.9, pág. 337 | Manual de Puentes (vía AASHTO) | [CA:4109](src/criterios_adoptados.py:4109), `diseno_flexion_corte` [M9:3152](src/modulos/M9_cabezal.py:3152) | [A] |
...
| `NUMERAL_C_PHI`: en cohesivos φ=0, en friccionantes c=0 (prohibido sumar) | Art. 20, pág. 33 | E.050 | [CN:2464](src/constantes_normativas.py:2464), [M9:2126](src/modulos/M9_cabezal.py:2126) `verificar_deslizamiento`, [M9:2126](src/modulos/M9_cabezal.py:2126) `parametros_resistencia_art20` | [N] |
| `NUMERAL_ZAPATA_TALUD_E050`: doble verificación (inclinación de superficie y de base + estabilidad global del talud) | Art. 30.1-30.2 | E.050 | [CN:2465](src/constantes_normativas.py:2465), [M9:3327](src/modulos/M9_cabezal.py:3327) `condicion_normativa_cabezal` | [N] |
...
| `verificar_capacidad_portante()` ≥ 3.00 / 2.50 | Art. 21.1/21.2 | E.050 | [M9:2079](src/modulos/M9_cabezal.py:2079) | [N] |
| `e2_volteo()` ≥ 1.50 / 1.25 | num. 39.13.6 a) | E.050 | [M9:903](src/modulos/M9_cabezal.py:903) | [N] |
| `verificar_deslizamiento()` (E3) ≥ 1.50 / 1.25 | num. 39.13.6 a) | E.050 | [M9:2126](src/modulos/M9_cabezal.py:2126) | [N] |
| `verificar_estabilidad_global()` (E4) ≥ 1.50 / 1.25 | num. 39.13.6 b) | E.050 | [M9:2150](src/modulos/M9_cabezal.py:2150) | [N] |
| `verificar_talud()` (E5) ≥ 1.50 / 1.25 | Art. 30.3 | E.050 | [M9:2169](src/modulos/M9_cabezal.py:2169) | [N] |
...
| `RECUBRIMIENTO` (vía `recubrimiento_e060_mm`): contra suelo 70 mm; suelo/intemperie ≥ 3/4" 50 mm; ≤ 5/8" 40 mm | Art. 7.7.1, pág. 54 | E.060 | [CN:2618-296](src/constantes_normativas.py:2618), [M9:2336](src/modulos/M9_cabezal.py:2336) | [N] |
...
| `ESPESOR_TEMPERATURA_DOS_CARAS = 0.250` m (refuerzo en dos caras; lo lee `requiere_temperatura_dos_caras`) | Art. 14.8.3 | E.060 | [CN:2714-320](src/constantes_normativas.py:2714), [M9:3012](src/modulos/M9_cabezal.py:3012) | [N] |
