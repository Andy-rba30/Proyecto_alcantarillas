...
| Alternativa citada si el barril no llena: procedimiento de barril parcialmente lleno — lo declara `geometria_control_salida` | Cap. III | HDS-5 | [CA:2057](src/criterios_adoptados.py:2057), [M4:657](src/modulos/M4_control.py:657) | [C] |
