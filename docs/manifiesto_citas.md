...
| `NUMERAL_SUBPRESION = "Manual de Puentes num. 2.4.3.8.2"` (subpresión del cabezal) | 2.4.3.8.2 | Manual de Puentes | [M9:272](src/modulos/M9_cabezal.py:272), [M9:272](src/modulos/M9_cabezal.py:272) | [N] |
| `presion_sobrecarga_trasdos()`: p = γ·0.60·k_a; aplica con tráfico a ≤ H/2 | num. 2.1.4.3.9 | Manual de Puentes | [M9:1045](src/modulos/M9_cabezal.py:1045), [M9:1045](src/modulos/M9_cabezal.py:1045) | [N] |
...
| `NUMERAL_C_PHI`: en cohesivos φ=0, en friccionantes c=0 (prohibido sumar) | Art. 20, pág. 33 | E.050 | [CN:1850](src/constantes_normativas.py:1850), [M9:1863](src/modulos/M9_cabezal.py:1863), [M9:1902](src/modulos/M9_cabezal.py:1902) | [N] |
...
| `RECUBRIMIENTO`: contra suelo 70 mm; suelo/intemperie ≥ 3/4" 50 mm; ≤ 5/8" 40 mm | Art. 7.7.1, pág. 54 | E.060 | [CN:1970-296](src/constantes_normativas.py:1970), [M9:1162](src/modulos/M9_cabezal.py:1162) | [N] |
...
| `ESPESOR_TEMPERATURA_DOS_CARAS = 0.250` m (refuerzo en dos caras) | Art. 14.8.3 | E.060 | [CN:2066-320](src/constantes_normativas.py:2066), [M9:1452](src/modulos/M9_cabezal.py:1452) | [N] |
...
| `NUMERAL_9_2` / `NUMERAL_9_3` / `NUMERAL_MO` | `"Sec. 9.2"` / `"Sec. 9.3 (E.050)"` / `"Sec. 9.2 (Mononobe-Okabe)"` | [M9:267-186](src/modulos/M9_cabezal.py:267) |
