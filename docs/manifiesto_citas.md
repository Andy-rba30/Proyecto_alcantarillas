...
| `SPT_ESPACIAMIENTO = 1.0` m entre ensayos | **⚠ sin numeral propio** (hereda el Art. 38 de la línea anterior; `clase_sitio` sí lo cita como Art. 38) | E.050 | [CN:3107](src/constantes_normativas.py:3107), [CA:899](src/criterios_adoptados.py:899) | [N] |
