...
| Ecuaciones de control de entrada: q* ≤ 3.5 → HWi/D = Hc/D + K·(q*)^M + Ks·S; q* ≥ 4.0 → HWi/D = c·(q*)² + Y + Ks·S — lo declara `control_entrada` | **Num. A.2, ecs. (A.1)–(A.3), págs. impresas A.1–A.2** (`NOR-HDS-03`): las ecuaciones están en el texto; de la Tabla A.1 (pág. A.8) salen solo las constantes | HDS-5 | [M4:729](src/modulos/M4_control.py:729) | [N] |
...
| Alternativa citada si el barril no llena: procedimiento de barril parcialmente lleno — lo declara `geometria_control_salida` | Cap. III | HDS-5 | [CA:2305](src/criterios_adoptados.py:2305), [M4:895](src/modulos/M4_control.py:895) | [C] |
