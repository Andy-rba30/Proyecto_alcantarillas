...
| `procedimiento_flexion_corte_aashto_sec5 = None` — remisión a AASHTO Sec. 5 | Manual de Puentes Sección 2.9, pág. 337 | Manual de Puentes (vía AASHTO) | [CA:4109](src/criterios_adoptados.py:4109), `diseno_flexion_corte` [M9:3188](src/modulos/M9_cabezal.py:3188) | [A] |
