...
| `TR = 1/(1-(1-R)^(1/n))`, sin piso normativo — la resuelve `M1.tr_desde_riesgo` con el R y el n que da `TABLA_02_FILAS` | num. 3.6 (fórmula, no lista de TR) | Manual de Hidrología | [CN:302](src/constantes_normativas.py:302), [M1:268](src/modulos/M1_clasificacion.py:268) | [N] |
...
| `empuje_flotacion_kn_m()` — U por metro lineal, conducto sumergido | num. 2.4.3.8.2 | Manual de Puentes | [M8:244](src/modulos/M8_estructural.py:244), [M8:251](src/modulos/M8_estructural.py:251) | [N] |
| `NUMERAL_V7 = "Fase 5, V7 (Manual de Puentes num. 2.4.3.8.2 + Fase 8, item 3)"` | 2.4.3.8.2 | Manual de Puentes | [M5:302](src/modulos/M5_verificaciones.py:302), [M8:188](src/modulos/M8_estructural.py:188) | [N] |
...
| **Afirmación negativa**: AASHTO LRFD Sec. 12 NO está incorporada por el Manual de Puentes (difiere rigidez de anillo, pandeo y costura) — lo declara `verificacion_diferida_estructural` | Sec. 12 de AASHTO, no incorporada | Manual de Puentes | [M8:437](src/modulos/M8_estructural.py:437), [M8:437](src/modulos/M8_estructural.py:437), [M8:437](src/modulos/M8_estructural.py:437) | [C] |
...
| Rigidez de anillo, pandeo y resistencia de costura: **diferidos al expediente** — lo declara `verificacion_diferida_estructural` | Sec. 12 | AASHTO LRFD | [M8:437](src/modulos/M8_estructural.py:437), [M8:437](src/modulos/M8_estructural.py:437) | [C] |
...
|---|---|---|
| `NUMERAL_FAMILIA` | `"Sec. 2.3"` — "la hoja de ruta, sin numeral MTC propio" | [M1:125](src/modulos/M1_clasificacion.py:125) |
